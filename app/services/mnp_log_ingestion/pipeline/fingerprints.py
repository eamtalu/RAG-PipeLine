...
_DERIVE_VERSION = 4  # 4 = 18ad late work rejoins + URL method (chunk 97); 3 = 18ac response ownership (chunk 95); 2 = 18r server-scoped grouping (chunk 67); 1 = S3 as shipped
